        ...
        _createClass(e, null, [
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                o > 0 &&
                !isNaN(parseInt(e.substring(o + 5, e.indexOf(".", o)), 10))
              );
            },
          },
        ]),
          ...
          },
          {
            ...
            value: function () {
              ...
              if (!e.length)
                if (n)
                  for (
                    var i = this.element.className.split(" "),
                      s = 0,
                      r = i.length;
                    s < r;
                    s++
                  ...
                  for (
                    var l = document.querySelector("." + t + "-container");
                    l.firstChild;
      ...
      function e(n) {
        _classCallCheck(this, e),
          ...
          this.options.content.id &&
            this.element.setAttribute("id", t + "-" + this.options.content.id),
          u.check(h, this.options.content.effect) ||
              ...
              return new Promise(function (n, o) {
                ...
                if (s && 11 == s[2].length) {
                  ...
                  if (
                    (l.setAttribute(
                      "src",
                      "https://www.youtube.com/embed/" + s[2]
                    ),
                  ...
                  u
                    ? (e.options.content.clone
                      ...
                      e.options.content.width &&
                        (u.style.flexBasis = e.options.content.width),
              ...
              switch (e) {
                case o:
                  (this.element.style.animationDelay = "0ms"),
                    (this.element.style.animationDuration =
                      this.options.content.speedOut + "ms"),
                    this.element.classList.remove(n),
                    this.element.classList.add(o),
                    this.setAnimation("animateTo");
                  break;
              ...
              value: function () {
                ...
                this.build(),
                  ...
                  this.content
                    .fetch()
                    .then(function () {
                      u.check(d, e.options.content.effect) &&
                        (e.scroll = new m()),
              ...
              value: function () {
                ...
                document.addEventListener(
                  ...
                  this.options.content.close &&
                    document.addEventListener("keydown", this.action, !0),
